...
\begin{enumerate}
  \item Retrieve titles of all papers from 2014 using the index.
  \item Tokenize each title, remove punctuation and stop words.
  \item Use part-of-speech tagger\footnote{\url{http://nlp.stanford.edu/software/tagger.shtml}} to assign parts of speech to each word, such as noun, verb, adjective, etc.
  \item Extract topics from the tagged words based on a given pattern, using regular expression tools.
\end{enumerate}
