...
\begin{itemize}
  ...
  \item Use Part-Of-Speech Tagger (POS Tagger)\footnote{http://nlp.stanford.edu/software/tagger.shtml} to assign parts of speech to each word, such as noun, verb, adjective, etc.
